...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        m2m_table_name = db.shorten_name(u'core_topic_users')
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'core_topic_users'))
    ...
    models = {
        ...
        u'core.topic': {
            ...
            'users': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'topics'", 'symmetrical': 'False', 'to': u"orm['auth.User']"})
        }
    }
